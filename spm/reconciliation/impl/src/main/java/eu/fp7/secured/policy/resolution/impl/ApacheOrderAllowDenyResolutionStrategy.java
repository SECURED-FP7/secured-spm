...
/**
 * The Class ApacheOrderAllowDenyResolutionStrategy.
 */
public class ApacheOrderAllowDenyResolutionStrategy extends GenericConflictResolutionStrategy {
	
	/** The Constant label. */
	private static final String label = "Apache Order Allow,Deny";
	
	/** The Constant label_simple. */
	private static final String label_simple = "Apache OAD";
