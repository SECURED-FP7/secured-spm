...
/**
 * The Class ApacheOrderDenyAllowResolutionStrategy.
 */
public class ApacheOrderDenyAllowResolutionStrategy extends GenericConflictResolutionStrategy {

	/** The Constant label. */
	private static final String label = "Apache Order Deny,Allow";
	
	/** The Constant label_simple. */
	private static final String label_simple = "Apache ODA";
